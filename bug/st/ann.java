...
class ReplaceStringViewModelTest {
    ...
    @CsvSource({ "randomText, replaceText, author, TRUE, FALSE, 0", // does not replace
                                                                    // when findString
                                                                    // does not exist in
                                                                    // the selected field
            "Informatics, replaceText, randomField, TRUE, FALSE, 0", // does not replace
                                                                     // if the BibEntry
                                                                     // does not have
                                                                     // selected field

            "Informatics, replaceText, journaltitle, TRUE, FALSE, 1", // replace
                                                                      // "Informatics" in
                                                                      // the JOURNALTITLE
                                                                      // field to
                                                                      // "replaceText" in
                                                                      // the BibEntry
            "Informatics, replaceText, journaltitle, TRUE, TRUE, 1", // replace
                                                                     // "Informatics" in
                                                                     // the JOURNALTITLE
                                                                     // field to
                                                                     // "replaceText" in
                                                                     // the BibEntry
            "Informatics, replaceText, journaltitle, FALSE, FALSE, 1", // replace
                                                                       // "Informatics" in
                                                                       // the JOURNALTITLE
                                                                       // field to
                                                                       // "replaceText" in
                                                                       // the BibEntry
            "Informatics, replaceText, journaltitle, FALSE, TRUE, 1", // replace
                                                                      // "Informatics" in
                                                                      // the JOURNALTITLE
                                                                      // field to
                                                                      // "replaceText" in
            ...
            "2020, 2021, date, TRUE, FALSE, 1", // only replace "2020" in the DATE field
                                                // to "2021" in the BibEntry
            "2020, 2021, date, FALSE, TRUE, 2", // replace all the "2020"s in the entries
            "2020, 2021, date, FALSE, FALSE, 1", // only replace "2020" in the DATE field
                                                 // to "2021" in the BibEntry
            "2020, 2021, date, TRUE, TRUE, 2", // replace all the "2020"s in the entries

            "System, replaceText, title, FALSE, TRUE, 1", // replace "System" in all
                                                          // entries is case-sensitive
            "and, '', author, TRUE, FALSE, 2", // replace two "and"s with empty string in
                                               // the same AUTHOR field
            "' ', ',', date, TRUE, FALSE, 1" // replace space with comma in DATE field
    })
    void replace(String findString, String replaceString, String fieldString, boolean selectOnly,
            boolean allFieldReplace, int expectedResult) {
