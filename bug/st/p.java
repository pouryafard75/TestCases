...
public enum PostgreConstants {
    ...
    BIB_FIELDS_SCHEME("bib_fields"), SPLIT_TABLE_SUFFIX("_split_values"), ENTRY_ID("entryid"), FIELD_NAME("field_name"),
    FIELD_VALUE_LITERAL("field_value_literal"), // contains the value as-is
    FIELD_VALUE_TRANSFORMED("field_value_transformed"); // contains the value transformed
                                                        // for better querying
    ...
    public static final List<String> POSTGRES_FUNCTIONS = List.of(
            ...
            // Source:
            // https://www.postgresql.org/message-id/flat/0aabac3c-9049-4c55-a82d-a70c5ba43d4d%40www.fastmail.com
            """
    ...
    /**
     * Generates the schema reference for the split table, which is used to store
     * multi-value fields (e.g., authors, keywords) in a normalized form to facilitate
     * efficient querying and indexing of the data.
     */
