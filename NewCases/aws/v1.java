...
public class CreateJobResult implements Serializable, Cloneable {
     ...
     * <b>Allowed Values: </b>Import, Export
     *
     * @param jobType Specifies whether the job to initiate is an import or export
     *                job.
     *
     * @see JobType
     */
     ...
     * the SignatureFileContents value.
     *
     * @param signature An encrypted code used to authenticate the request and
     *                  response, for
     *                  example, "DV+TpDfx1/TdSE9ktyK9k/bDTVI=". Only use this value
     *                  is you
     *                  want to create the signature file yourself. Generally you
     *                  should use
     *                  the SignatureFileContents value.
     */
     ...
     * The actual text of the SIGNATURE file to be written to disk.
     *
     * @param signatureFileContents The actual text of the SIGNATURE file to be
     *                              written to disk.
     */
     ...
     * such as use of an incompatible Amazon S3 bucket name.
     *
     * @param warningMessage An optional message notifying you of non-fatal issues
     *                       with the job,
     *                       such as use of an incompatible Amazon S3 bucket name.
     */
    ...
    public void setArtifactList(java.util.Collection<Artifact> artifactList) {
        ...
        com.amazonaws.internal.ListWithAutoConstructFlag<Artifact> artifactListCopy = new com.amazonaws.internal.ListWithAutoConstructFlag<Artifact>(
                artifactList.size());
    ...
    public CreateJobResult withArtifactList(Artifact... artifactList) {
        if (getArtifactList() == null)
            setArtifactList(new java.util.ArrayList<Artifact>(artifactList.length));
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode
                + ((getSignatureFileContents() == null) ? 0 : getSignatureFileContents().hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSignatureFileContents() != null
                && other.getSignatureFileContents().equals(this.getSignatureFileContents()) == false)
            return false;
