...
public class CreateJobResult implements Serializable, Cloneable {
     ...
     *                              The new value for the SignatureFileContents
     *                              property for this
     *                              object.
     */
     ...
     *                       The new value for the WarningMessage property for this
     *                       object.
     */
     ...
     * 
     * @param artifactList
     *                     The new value for the ArtifactList property for this
     *                     object.
     */
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getWarningMessage() == null) ? 0
                        : getWarningMessage()
                                .hashCode());
        hashCode = prime
                * hashCode
                + ((getArtifactList() == null) ? 0
                        : getArtifactList()
                                .hashCode());
        return hashCode;
    }
