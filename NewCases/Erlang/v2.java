...
public abstract class ErlangCompilationTestBase extends PlatformTestCase {
    ...
    private Module createModuleInDirectory(String moduleName) throws IOException {
        ...
        return ModuleManager.getInstance(myProject).newModule(virtualFile.getPath(),
                ErlangModuleType.getInstance().getId());
    }
    ...
    protected static void assertSourcesCompiled(@NotNull Module module, boolean tests) {
        ...
        assertContains(getOutputDirectory(module, tests),
                ContainerUtil.mapNotNull(sources, new Function<String, String>() {
                    @Nullable
                    @Override
    ...
    protected static File getOutputFile(Module module, VirtualFile sourceFile, boolean isTest) {
        ...
        return expectedOutputFileName == null ? null
                : new File(outputDirectory.getCanonicalPath(), expectedOutputFileName);
    }
    ...
    private static String[] getSourceFiles(@NotNull Module module, boolean isTestSources) {
        ...
        List<String> result = ContainerUtil
                .concat(ContainerUtil.mapNotNull(sourceRoots, new Function<VirtualFile, List<String>>() {
                    @Override
