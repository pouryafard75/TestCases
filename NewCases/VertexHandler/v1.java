 ...
 */
package NewCases.VertexHandler;
...
public abstract class VertxHandler<C extends ConnectionBase> extends ChannelDuplexHandler {
    ...
    public void exceptionCaught(ChannelHandlerContext chctx, final Throwable t) throws Exception {
        ...
        // Don't remove the connection at this point, or the handleClosed won't be
        // called when channelInactive is called!
...
// http://refactoring.encs.concordia.ca/oracle/refactoring-details/1112031/7158